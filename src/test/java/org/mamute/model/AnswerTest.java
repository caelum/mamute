...
public class AnswerTest extends TestCase {
	...
	public void should_approve_answer_info() throws Exception {
		...
		Information approved = new AnswerInformation(pure("blablabalblab"), new LoggedUser(editUser, null), answer, "");
	...
	public void return_true_if_answer_has_pending_edits() throws Exception {
		...
		AnswerInformation approved = new AnswerInformation(pure("blablabalblab"), new LoggedUser(editUser, null), answer, "");
