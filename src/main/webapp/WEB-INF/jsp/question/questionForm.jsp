<form class="validated-form" action='<c:url value="/question/ask"/>' method="post" >
	...
	<label ><fmt:message key="newquestion.description" />
	
	<div class="wmd">
	      <div class="wmd-panel">
            	<div id="wmd-button-bar"></div>
            	<textarea class="required hintable wmd-input" id="wmd-input" data-hint-id="newquestion-description-hint" minlength="30" name="question.description"></textarea>
        	</div>
