...
<ul class="subheader-menu nav">
	...
	<li class="nav-item">
		<a class="order-by" data-type="${type}" data-target-id="${targetId}" href="<c:url value="/usuario/${user.id}/${user.sluggedName}/${type}?order=ByDate"/>"><fmt:message key="user_profile.order.date"/></a>
	</li>
</ul>