...
<form class="validated-form" action='<c:url value="${uri}"/>' method="post" >
	...
	<input id="question-title" type="text" class="required hintable" value="${question.title }" data-hint-id="newquestion-title-hint" minlength="15" name="question.title">
	...
	<div class="wmd">
		<div class="wmd-panel">
			...
			<textarea class="required hintable wmd-input" id="wmd-input"
				...
				name="question.description">${question.description }</textarea>
		</div>
