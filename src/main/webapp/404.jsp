...
<div class="not-found">
	...
	<ul>
		<li><fmt:message key="not_found.recent_questions"><fmt:param value="${linkTo[ListController].home[null]}"/></fmt:message></li>
		<li><fmt:message key="not_found.search"><fmt:param value="${linkTo[SearchController].search[null]}"/></fmt:message></li>
