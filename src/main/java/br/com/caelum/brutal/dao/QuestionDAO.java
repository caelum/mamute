...
public class QuestionDAO {
	...
	public List<Question> withTag(Tag tag) {
		List<Question> questions = session.createQuery("select q from Question as q join q.questionInformation.tags t where " + spamFilter() + " and (q.solution is null) and t = :tag order by q.lastUpdatedAt desc")
