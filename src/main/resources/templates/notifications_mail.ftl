...
<body style="font-family:arial, sans-serif; font-size:12px;">
	<div style="color:#222; font-size:14px; line-height:1.2em; padding:8px 0 8px 10px; background-color:#edf2f4;">${localization.getMessage("notifications_mail.table_title")}</div>
